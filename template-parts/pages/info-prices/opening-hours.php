...
<section id="section-opening-hours" class="section-opening-hours bg-white pb-12 xl:pb-20">
	<div class="theme-container">
		<div class="theme-grid pb-32 md:pb-28 xl:pb-36">
	...
	<div class="theme-container">
		<div class="theme-grid pt-12 md:pt-28 xl:pt-36 pb-32 md:pb-28 xl:pb-40">
			<div class="col-span-2 md:col-start-1 md:col-span-3 xl:col-start-2 xl:col-span-4">
	...
	<div class="theme-container">
		<div class="theme-grid pt-12 md:pt-28 pb-20 md:pb-32 xl:pb-52">
			<div class="col-span-2 md:col-start-1 md:col-span-3 xl:col-start-2 xl:col-span-4">
