<?php
/**
 * Opening Hours Section in the Activities Page Template.
 *
 * @package erlebnisbad
 * @subpackage Section
 * @since 1.0.0
...
<section id="section-opening-hours" class="section-opening-hours bg-white pt-48 xl:pt-32 pb-48 xl:pb-32">
  <div class="theme-container">
    <div class="theme-grid">
      ...
      <div class="col-span-2 md:col-start-5 xl:col-start-10 md:pb-12 order-2 md:order-none flex justify-end">
       <?php
