...
<section id="section-bistro" class="section-bistro bg-Mint1 waves waves__top--color waves__bottom--color">
  <div class="theme-container pb-32 md:pb-24 xl:pb-40">
    <div class="theme-grid">
      <div class="col-span-2 md:col-span-3 xl:col-start-2 xl:col-span-4 order-2 md:order-none pt-12 xl:pt-36">
        <?php
      ...
      <div class="col-span-2 md:col-start-4 md:col-span-3 xl:col-start-8 xl:col-span-4 pt-12 xl:pt-56">
