<?php
/**
 * Waterpark Section in the Home Page Template.
 *
 * @package erlebnisbad
 * @subpackage Section
 * @since 1.0.0
...
<section id="section-waterpark" class="section-waterpark bg-Mint3">
	<div class="theme-container pt-36 md:pt-24 xl:pt-10 pb-32 md:pb-24 xl:pb-36">
		<div class="theme-grid items-center">
			<div class="col-span-2 md:col-span-3 xl:col-start-2 xl:col-span-5">
				...
				<?php
				$hero_button = get_field( 'waterpark_button' );
				if ( $hero_button ) :
			...
			<div class="col-span-2 md:col-start-4 md:col-span-3 xl:col-start-8 xl:col-span-5">
				...
				if ( $img_id ) :
					?>
					<figure class="shape-bg shape-bg__img shape-bg--1 before:bg-Mint">
