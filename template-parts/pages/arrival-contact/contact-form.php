...
?>
<section id="section-contact-form" class="section-contact-form bg-Mint1 waves waves__top--color pt-12 md:pt-40 xl:pt-24 pb-32 md:pb-52 xl:pb-44">
    <div class="theme-container">
        ...
        <div class="theme-grid pt-12 md:pt-32 xl:pt-24">
