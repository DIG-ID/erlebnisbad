...
?>
<section id="section-content" class="section-content bg-Mint1 waves waves__top--color waves__bottom--color pt-12 xl:pt-24 pb-32 md:pb-40 xl:pb-24">
    <div class="theme-container">
        <div class="theme-grid grid-flow-row-dense">
            ...
            <div class="col-span-2 md:col-start-1 md:col-span-3 xl:col-start-2 xl:col-span-5 xl:pt-20 text-center justify-items-center md:text-left md:justify-items-start">
                ...
                <p class="text-Black xl:max-w-[593px]"><?php the_field( 'content_text' ); ?></p>
            </div>
        </div>
    </div>
</section>
