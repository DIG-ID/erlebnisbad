	...
	<div class="theme-container">
		<div class="theme-grid gap-y-12 md:gap-y-20 xl:gap-y-24">
			...
			<?php if ( have_rows( 'team_members' ) ) : ?>
				<div class="col-span-2 md:col-span-6 xl:col-start-2 xl:col-span-9">
					<div class="grid grid-cols-2 md:grid-cols-6 xl:grid-cols-9 gap-x-5 md:gap-x-4 xl:gap-x-5 gap-y-12 md:gap-y-20 xl:gap-y-24">
						<?php
						$team_index = 0;
						while ( have_rows( 'team_members' ) ) :
							...
							++$team_index;
							?>
							<article class="col-span-2 md:col-span-3 xl:col-span-3 section-team__card flex md:flex-col items-center text-center gap-x-6 md:gap-x-0">
								<?php if ( $picture_id ) : ?>
									<figure class="shape-bg shape-bg__img shape-bg--<?php echo (int) $shape; ?> before:bg-Mint2 w-full !max-w-[150px] md:!max-w-[280px] xl:!max-w-[320px] md:mb-8">
										<?php
