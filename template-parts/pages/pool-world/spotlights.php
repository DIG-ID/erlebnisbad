    ...
    <div class="theme-container">
        <div class="theme-grid">
            ...
            <div class="col-span-2 md:col-start-4 md:col-span-3 xl:col-start-7 xl:col-span-4 xl:pt-40">
                 ...
                 */
                ?>
            <div class="col-span-2 md:col-start-4 md:col-span-3 xl:col-start-2 xl:col-span-5 pt-8 md:pt-24 xl:pt-60 xl:pl-16">
            ...
            <div class="col-span-2 md:col-start-1 md:col-span-3 xl:col-start-8 xl:col-span-4 pt-14 md:pt-36 xl:pt-32">
